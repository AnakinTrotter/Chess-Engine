 ...
 ****************************************************************************/
bool ChessRules::IsDraw()
{
    bool   draw=false;

    // Insufficient mating material
    draw =  IsInsufficientDraw();
 ...
 ****************************************************************************/
bool ChessRules::IsInsufficientDraw()
{
    char   piece;
    int    piece_count=0;
...
/****************************************************************************
 * Create a list of all legal moves (sorted weakest first, public version)
 ****************************************************************************/
void ChessEvaluation::GenLegalMoveListSorted( vector<Move> &moves )
{
    MOVELIST movelist;
    GenLegalMoveListSorted( &movelist ); // order reversed by Anakin Trotter
 ...
 ****************************************************************************/
void ChessEvaluation::GenLegalMoveListSortedReg( vector<Move> &moves )
{
    MOVELIST movelist;
    GenLegalMoveListSorted( &movelist ); // order reversed by Anakin Trotter
    for( int i=0; i<movelist.count; i++ )
 ...
 * Create a list of all legal moves (sorted strongest first, public version)
 ****************************************************************************/
void ChessEvaluation::GenLegalMoveListSorted( list<Move> &moves )
{
    MOVELIST movelist;
